...
; ANIM_OBJ_LEAF_STORM
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_12, BATTLEANIMFUNC_USER_TO_TARGET_SPIN, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT
...
; ANIM_OBJ_LEAVES_BUILDUP
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_2E, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT
; ANIM_OBJ_HAIL
	battleanimobj RELATIVE_X, $00, BATTLEANIMFRAMESET_12, BATTLEANIMFUNC_HAIL, PAL_BATTLE_OB_GRAY, ANIM_GFX_ICE
; ANIM_OBJ_ENERGY_BALL
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GREEN, ANIM_GFX_CHARGE
; ANIM_OBJ_OUTWARDS_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_25, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_GREEN, ANIM_GFX_CHARGE
; ANIM_OBJ_SMOKE_UP
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_GRAY, ANIM_GFX_SMOKE
; ANIM_OBJ_RED_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_44, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_RED_ENERGY_BALL_WAVE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_GRAY_SOLAR_BEAM_CHARGE_LOWER
	battleanimobj RELATIVE_X, $8D, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE
; ANIM_OBJ_GRAY_SOLAR_BEAM_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE
; ANIM_OBJ_OUTWARDS_RED_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_25, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_RED_ENERGY_BALL
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_ICE_SHARD_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE
; ANIM_OBJ_THROW_ICE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_HORIZONTAL_ICE
; ANIM_OBJ_LOWER_MIST
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE
; ANIM_OBJ_DEBRIS
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_DIG, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_POWERGEM_CHARGE
	battleanimobj RELATIVE_X, $c0, BATTLEANIMFRAMESET_26, BATTLEANIMFUNC_STRENGTH_SEISMIC_TOSS, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE
; ANIM_OBJ_POWERGEM_ROCK
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_STRENGTH_SEISMIC_TOSS, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ROCKS
; ANIM_OBJ_ROCK_WRECKER_CHARGE
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_ROCK_WRECKER_SMALL_CHARGE
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_HUGE_ROCK_CENTER
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_1B, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_BIG_ROCK_CENTER
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_THROW_HUGE_ROCK
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_1B, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ROCKS
; ANIM_OBJ_OUTWARDS_ROCKS
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_FALLING_STARS
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_USER_TO_TARGET_DIAGONALLY, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS
; ANIM_OBJ_PUNCH_SHAKE_YELLOW
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_07, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_HIT
; ANIM_OBJ_BROWN_WATER_GUN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $80, BATTLEANIMFRAMESET_27, BATTLEANIMFUNC_WATER_GUN, PAL_BATTLE_OB_BROWN, ANIM_GFX_WATER
; ANIM_OBJ_SLUDGE_CENTERED
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_SLUDGE, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON
; ANIM_OBJ_BEAM_BLUE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_BEAM
; ANIM_OBJ_BEAM_TIP_BLUE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_BLUE, ANIM_GFX_BEAM
; ANIM_OBJ_HIDDEN_POWER_GRAY
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE
; ANIM_OBJ_OUTWARDS_SMALL_ICE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE
; ANIM_OBJ_MUD_BOMB_BALL
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_CHARGE
; ANIM_OBJ_LOWER_HAZE_BROWN
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_BROWN, ANIM_GFX_HAZE
; ANIM_OBJ_EXPLOSION3
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BROWN, ANIM_GFX_EXPLOSION
; ANIM_OBJ_CUT_LONG_DOWN_LEFT_GREEN
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_41, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GREEN, ANIM_GFX_CUT
; ANIM_OBJ_CUT_LONG_DOWN_RIGHT_GREEN
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_42, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GREEN, ANIM_GFX_CUT
; ANIM_OBJ_DISCHARGE_BALL
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_A8, BATTLEANIMFUNC_HIDDEN_POWER, PAL_BATTLE_OB_YELLOW, ANIM_GFX_LIGHTNING
; ANIM_OBJ_BEAM_GRAY
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_BEAM
; ANIM_OBJ_BEAM_TIP_GRAY
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_GRAY, ANIM_GFX_BEAM
; ANIM_OBJ_POLTERGEIST
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_99, BATTLEANIMFUNC_POLTERGEIST, PAL_BATTLE_OB_GRAY, ANIM_GFX_STATUS
; ANIM_OBJ_LIFE_DEW
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $38, BATTLEANIMFRAMESET_28, BATTLEANIMFUNC_LIFE_DEW, PAL_BATTLE_OB_BLUE, ANIM_GFX_WATER
; ANIM_OBJ_CRYOGENICE
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_12, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE