...
; ANIM_OBJ_SMOKE_UP
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_28, BATTLEANIMFUNC_OUTWARDS_CHARGE, PAL_BATTLE_OB_GRAY, ANIM_GFX_SMOKE
; ANIM_OBJ_RED_CHARGE
...
; ANIM_OBJ_THROW_ICE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_57, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_HORIZONTAL_ICE
; ANIM_OBJ_LOWER_MIST
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE
; ANIM_OBJ_DEBRIS
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_0A, BATTLEANIMFUNC_DIG, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
...
; ANIM_OBJ_POWERGEM_ROCK
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_0A, BATTLEANIMFUNC_STRENGTH_SEISMIC_TOSS, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ROCKS
...
; ANIM_OBJ_ROCK_WRECKER_SMALL_CHARGE
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_0A, BATTLEANIMFUNC_SOLAR_BEAM, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
