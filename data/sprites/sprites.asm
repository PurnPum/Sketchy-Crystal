...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite KrisSwimGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	...
	overworld_sprite ChrisSwimGFX, 12, WALKING_SPRITE, PAL_OW_RED
	...
	overworld_sprite ShuckleSpriteGFX, 4, STILL_SPRITE, PAL_OW_RED
	overworld_sprite RainDropSpriteGFX, 4, STILL_SPRITE, PAL_OW_BLUE
	overworld_sprite SwinubSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
