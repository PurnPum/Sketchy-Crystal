...
MapGroup_Olivine:
	...
	map OlivineCity, TILESET_JOHTO_OLIVINE, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map ShuckleCave, TILESET_CAVE, CAVE, LANDMARK_SHUCKLE_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_JOHTO_ECRUTEAK, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Goldenrod:
	...
	map Route34, TILESET_JOHTO_GOLDENROD, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GoldenrodCity, TILESET_JOHTO_GOLDENROD, TOWN, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
