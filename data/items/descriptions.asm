...
VenomSpearDesc:
	db   "Always poison foe"
	next "with BEEDRILL STAB@"
...
GiftSackDesc:
	db   "DELIBIRD will crit"
	next "all ICE-type moves@"
...
HandyTailDesc:
	db   "AIPOM. 1 Extra hit"
	next "on multi-hit moves@"
