...
; BattleTowerMons group 2
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, STRUGGLE, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, WIDE_BREAKER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db QUAGSIRE
	db QUICK_CLAW
	db NO_MOVE, EARTHQUAKE, SURF, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db NO_MOVE, SURF, NO_MOVE, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, TAKE_DOWN, HYPER_BEAM, BONEMERANG
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 4
	...
	db TAUROS
	db GOLD_BERRY
	db TAKE_DOWN, HYPER_BEAM, EARTHQUAKE, IRON_TAIL
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, WIDE_BREAKER, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db SLOWKING
	db MINT_BERRY
	db REST, SURF, PSYCHIC_M, NO_MOVE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, TAKE_DOWN
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, TAKE_DOWN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
