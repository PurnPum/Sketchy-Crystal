...
; BattleTowerMons group 1
	...
	db CORSOLA
	db SCOPE_LENS
	db BATTLE_SURF, PSYCHIC_M, RECOVER, ANCIENTPOWER
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db LAPRAS
	db MIRACLEBERRY
	db BLIZZARD, BATTLE_SURF, THUNDERBOLT, PSYCHIC_M
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db SNEASEL
	db GOLD_BERRY
	db SLASH, FAINT_ATTACK, BATTLE_SURF, BLIZZARD
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db SNORLAX
	db MIRACLEBERRY
	db HEADBUTT, PROTECT, SNORE, BATTLE_SURF
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db TOXIC, GIGA_DRAIN, NO_MOVE, CONFUSION
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, NO_MOVE, TAIL_WHIP, ICY_WIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db STARMIE
	db GOLD_BERRY
	db RECOVER, PSYCHIC_M, BATTLE_SURF, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STEELIX
	db GOLD_BERRY
	db ROAR, IRON_TAIL, NO_MOVE, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AZUMARILL
	db MYSTIC_WATER
	db BATTLE_SURF, BLIZZARD, ATTRACT, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MILTANK
	db KINGS_ROCK
	db EARTHQUAKE, THUNDER, ATTRACT, BATTLE_SURF
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, NO_MOVE, NO_MOVE, HEADBUTT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db NIDOKING
	db BERRY
	db BLIZZARD, EARTHQUAKE, BATTLE_SURF, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db QUAGSIRE
	db QUICK_CLAW
	db NO_MOVE, EARTHQUAKE, BATTLE_SURF, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db NO_MOVE, BATTLE_SURF, NO_MOVE, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db LEFTOVERS
	db THUNDER_WAVE, PSYCHIC_M, RECOVER, BATTLE_SURF
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db JYNX
	db GOLD_BERRY
	db BLIZZARD, NO_MOVE, DREAM_EATER, ATTRACT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BELLOSSOM
	db BRIGHTPOWDER
	db GIGA_DRAIN, SUNNY_DAY, SOLARBEAM, NO_MOVE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db LANTURN
	db GOLD_BERRY
	db RAIN_DANCE, THUNDER, BATTLE_SURF, FLAIL
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GENGAR
	db GOLD_BERRY
	db NO_MOVE, LICK, NIGHT_SHADE, GIGA_DRAIN
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 4
	...
	db KINGDRA
	db LEFTOVERS
	db BATTLE_SURF, DRAGONBREATH, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNORLAX
	db QUICK_CLAW
	db ATTRACT, BODY_SLAM, NO_MOVE, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LAPRAS
	db LEFTOVERS
	db THUNDERBOLT, ICE_BEAM, CONFUSE_RAY, BATTLE_SURF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db LEFTOVERS
	db BLIZZARD, THUNDERBOLT, BATTLE_SURF, PSYCHIC_M
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SLOWBRO
	db MIRACLEBERRY
	db BATTLE_SURF, PSYCHIC_M, EARTHQUAKE, BLIZZARD
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PORYGON2
	db NO_ITEM
	db CONVERSION2, CONVERSION, PSYBEAM, NO_MOVE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db GOLD_BERRY
	db NO_MOVE, WATER_GUN, ANCIENTPOWER, ROCK_SMASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db EGG_BOMB, STOMP, NO_MOVE, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MUK
	db QUICK_CLAW
	db SCREECH, TOXIC, SLUDGE, NO_MOVE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 5
	...
	db KINGDRA
	db GOLD_BERRY
	db BATTLE_SURF, HYPER_BEAM, BLIZZARD, DRAGONBREATH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SNORLAX
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, BATTLE_SURF, NO_MOVE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db LAPRAS
	db GOLD_BERRY
	db THUNDERBOLT, BATTLE_SURF, CONFUSE_RAY, BLIZZARD
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SCIZOR
	db LEFTOVERS
	db HYPER_BEAM, SLASH, NO_MOVE, METAL_CLAW
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SLOWKING
	db MINT_BERRY
	db REST, BATTLE_SURF, PSYCHIC_M, NO_MOVE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db SCOPE_LENS
	db THUNDER_WAVE, RECOVER, THUNDERBOLT, BATTLE_SURF
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db FORRETRESS
	db LEFTOVERS
	db SANDSTORM, TOXIC, EXPLOSION, NO_MOVE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, BATTLE_SURF, RAIN_DANCE, ZAP_CANNON
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db KINGDRA
	db LEFTOVERS
	db DRAGONBREATH, BATTLE_SURF, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db DRAGONITE
	db MIRACLEBERRY
	db HYPER_BEAM, ICY_WIND, THUNDERBOLT, BATTLE_SURF
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SNORLAX
	db PINK_BOW
	db ROCK_SLIDE, BATTLE_SURF, BODY_SLAM, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLASTOISE
	db GOLD_BERRY
	db BATTLE_SURF, EARTHQUAKE, RAPID_SPIN, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db RHYDON
	db QUICK_CLAW
	db EARTHQUAKE, BATTLE_SURF, IRON_TAIL, ROCK_SLIDE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PARASECT
	db GOLD_BERRY
	db NO_MOVE, GIGA_DRAIN, HYPER_BEAM, SLUDGE_BOMB
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db VAPOREON
	db LEFTOVERS
	db BLIZZARD, SHADOW_BALL, BATTLE_SURF, MUD_SLAP
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db BRIGHTPOWDER
	db BATTLE_SURF, THUNDERBOLT, HYPER_BEAM, ROAR
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db QUAGSIRE
	db MIRACLEBERRY
	db EARTHQUAKE, BATTLE_SURF, SLUDGE_BOMB, IRON_TAIL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GIRAFARIG
	db GOLD_BERRY
	db NO_MOVE, BATON_PASS, CRUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db LAPRAS
	db MINT_BERRY
	db REST, BATTLE_SURF, CONFUSE_RAY, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GENGAR
	db NO_ITEM
	db THUNDERBOLT, SHADOW_BALL, CONFUSE_RAY, NO_MOVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db FORRETRESS
	db LEFTOVERS
	db EXPLOSION, TOXIC, SOLARBEAM, NO_MOVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db KINGDRA
	db MINT_BERRY
	db REST, BATTLE_SURF, BLIZZARD, DRAGONBREATH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db DRAGONITE
	db GOLD_BERRY
	db THUNDER_WAVE, BATTLE_SURF, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db JYNX
	db QUICK_CLAW
	db NO_MOVE, BLIZZARD, DREAM_EATER, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db MANTINE
	db GOLD_BERRY
	db BATTLE_SURF, CONFUSE_RAY, BLIZZARD, WING_ATTACK
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db DUGTRIO
	db SCOPE_LENS
	db SLASH, EARTHQUAKE, NO_MOVE, MUD_SLAP
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	db STARMIE
	db LEFTOVERS
	db RECOVER, THUNDERBOLT, BATTLE_SURF, PSYCHIC_M
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db CLOYSTER
	db LEFTOVERS
	db EXPLOSION, BLIZZARD, BATTLE_SURF, ICY_WIND
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LAPRAS
	db MINT_BERRY
	db REST, BATTLE_SURF, THUNDERBOLT, PSYCHIC_M
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SNORLAX
	db MIRACLEBERRY
	db FIRE_BLAST, BATTLE_SURF, EARTHQUAKE, HYPER_BEAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 10
	...
	db KINGDRA
	db LEFTOVERS
	db BATTLE_SURF, DRAGONBREATH, REST, TOXIC
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db RHYDON
	db MIRACLEBERRY
	db BATTLE_SURF, EARTHQUAKE, HYPER_BEAM, ROCK_SLIDE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db STEELIX
	db LEFTOVERS
	db EARTHQUAKE, HYPER_BEAM, NO_MOVE, CRUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db LEFTOVERS
	db BATTLE_SURF, ANCIENTPOWER, BLIZZARD, TOXIC
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db QUICK_CLAW
	db BATTLE_SURF, RAIN_DANCE, ZAP_CANNON, CONFUSE_RAY
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 30000
