...
IcePath1FWaterCannon:
	itemball WATER_CANNON
...
IcePath1F_MapEvents:
	...
	def_object_events
	object_event 31,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IcePath1FWaterCannon, EVENT_GOT_HM07_WATERFALL
