...
MountMortar2FInside_MapEvents:
	...
	def_warp_events
	warp_event 17, 33, MOUNT_MORTAR_1F_OUTSIDE, 5
	...
	object_event 15, 31, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 2, TrainerSupernerdHugh, -1
