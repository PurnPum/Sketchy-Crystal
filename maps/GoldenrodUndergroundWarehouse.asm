...
GoldenrodUndergroundWarehouseSuperEther:
...
GoldenrodUndergroundWarehouse_MapEvents:
	...
	object_event 18, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodUndergroundWarehouseSuperEther, EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_SUPER_ETHER
