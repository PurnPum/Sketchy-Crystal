...
IcePathB2FMahoganySideUltraPotion:
...
IcePathB2FMahoganySide_MapEvents:
	...
	object_event  0,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IcePathB2FMahoganySideUltraPotion, EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_ULTRA_POTION
