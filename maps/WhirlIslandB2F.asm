...
WhirlIslandB2F_MapEvents:
	...
	object_event  5, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB2FSuperElixer, EVENT_WHIRL_ISLAND_B2F_SUPER_ELIXER
