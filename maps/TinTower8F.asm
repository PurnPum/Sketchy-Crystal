...
TinTower8F_MapEvents:
	...
	object_event 11,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, TinTower8FSuperElixer, EVENT_TIN_TOWER_8F_SUPER_ELIXER
