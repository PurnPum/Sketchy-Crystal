...
Route42_MapEvents:
	...
	warp_event 22,  9, MOUNT_MORTAR_1F_OUTSIDE, 2
	warp_event 28,  9, MOUNT_MORTAR_1F_OUTSIDE, 3
	warp_event 46,  7, MOUNT_MORTAR_1F_OUTSIDE, 4
	...
	bg_event 11, 11, BGEVENT_READ, MtMortarSign1
	bg_event 45,  9, BGEVENT_READ, MtMortarSign2
	bg_event 54,  8, BGEVENT_READ, Route42Sign2
	bg_event 20, 11, BGEVENT_ITEM, Route42HiddenUltraPotion

	def_object_events
	object_event 21, 11, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerFisherTully, -1
	object_event 53,  9, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, TrainerHikerBenjamin, -1
	object_event 48,  9, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerPokemaniacShane, -1
	object_event  5, 17, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route42UltraBall, EVENT_ROUTE_42_ULTRA_BALL
