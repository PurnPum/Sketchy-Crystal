...
MountMortar1FInsideUltraPotion:
...
MountMortar1FInside_MapEvents:
	...
	def_warp_events
	warp_event 11, 47, MOUNT_MORTAR_1F_OUTSIDE, 6
	warp_event 29, 47, MOUNT_MORTAR_1F_OUTSIDE, 7
	warp_event  5, 39, MOUNT_MORTAR_1F_OUTSIDE, 9
	warp_event 31,  9, MOUNT_MORTAR_1F_OUTSIDE, 10
	warp_event  3, 19, MOUNT_MORTAR_1F_OUTSIDE, 11
	...
	def_object_events
	object_event  9, 43, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MountMortar1FBoulder, -1
	...
	object_event 19, 27, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideHyperPotion, EVENT_MOUNT_MORTAR_1F_INSIDE_HYPER_POTION
	object_event 22, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideUltraPotion, EVENT_MOUNT_MORTAR_1F_INSIDE_ULTRA_POTION
	...
	object_event 27, 39, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacMiller, -1
	object_event  9, 26, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerSupernerdMarkus, -1
	...
	object_event 18, 36, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideUltraBall, EVENT_MOUNT_MORTAR_1F_INSIDE_ULTRA_BALL
