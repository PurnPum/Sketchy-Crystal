...
UnionCaveB2F_MapEvents:
	...
	object_event 16,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCaveB2FNugget, EVENT_UNION_CAVE_B2F_NUGGET
	object_event 16, 28, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCaveB2FStarPiece, EVENT_UNION_CAVE_B2F_STAR_PIECE
