...
Route45_MapEvents:
	...
	def_warp_events
	warp_event  2,  5, DARK_CAVE_ROUTE46_ENTRANCE, 1
	...
	object_event  7, 33, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route45UltraPotion, EVENT_ROUTE_45_ULTRA_POTION
