...
Route30_MapEvents:
	...
	def_warp_events
	warp_event  7, 39, ROUTE_36_NATIONAL_PARK_GATE, 1
	...
	bg_event  7, 13, BGEVENT_ITEM, Route30HiddenPotion
	...
	object_event  2, 23, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerYoungsterJoey, EVENT_ROUTE_30_YOUNGSTER_JOEY
	...
	object_event  6,  4, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherDon, -1
	...
	object_event 15, 44, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route30Ethers, EVENT_ROUTE_30_ETHERS
