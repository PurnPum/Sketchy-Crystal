...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_GRAY_SOLAR_BEAM_CHARGE_LOWER
	...
	const ANIM_OBJ_DEBRIS
	const ANIM_OBJ_POWERGEM_CHARGE
	const ANIM_OBJ_POWERGEM_ROCK
	const ANIM_OBJ_ROCK_WRECKER_CHARGE
	const ANIM_OBJ_ROCK_WRECKER_SMALL_CHARGE
	const ANIM_OBJ_HUGE_ROCK_CENTER
	const ANIM_OBJ_BIG_ROCK_CENTER
	const ANIM_OBJ_THROW_HUGE_ROCK
	const ANIM_OBJ_OUTWARDS_ROCKS
	const ANIM_OBJ_FALLING_STARS
	const ANIM_OBJ_PUNCH_SHAKE_YELLOW
	const ANIM_OBJ_BROWN_WATER_GUN
	const ANIM_OBJ_SLUDGE_CENTERED
	const ANIM_OBJ_BEAM_BLUE
	const ANIM_OBJ_BEAM_TIP_BLUE
	const ANIM_OBJ_HIDDEN_POWER_GRAY
	const ANIM_OBJ_OUTWARDS_SMALL_ICE
	const ANIM_OBJ_MUD_BOMB_BALL
	const ANIM_OBJ_LOWER_HAZE_BROWN
	const ANIM_OBJ_EXPLOSION3
	const ANIM_OBJ_CUT_LONG_DOWN_LEFT_GREEN
	const ANIM_OBJ_CUT_LONG_DOWN_RIGHT_GREEN
	const ANIM_OBJ_DISCHARGE_BALL
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_USER_TO_TARGET_DIAGONALLY
	...
	const BATTLEANIMFUNC_OUTWARDS_CHARGE
