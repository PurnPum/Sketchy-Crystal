...
; TreeMons indexes (see data/wild/treemons.asm)
	const_def
	const TREEMON_SET_CITY_1
	const TREEMON_SET_CITY_2
	const TREEMON_SET_CITY_3
	const TREEMON_SET_CITY_4
	const TREEMON_SET_BLANK
	const TREEMON_SET_CANYON
	const TREEMON_SET_ROUTE_1
	const TREEMON_SET_ROUTE_2
	const TREEMON_SET_ROUTE_3
