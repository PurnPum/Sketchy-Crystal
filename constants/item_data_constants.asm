...
; held item effects
	...
	const HELD_EXTEND_HAIL
	
	const_next 90
	const HELD_90
	const HELD_NORMAL_RESIST
	const HELD_GRASS_RESIST
	const HELD_FIRE_RESIST
	const HELD_WATER_RESIST
	const HELD_ICE_RESIST
	const HELD_FIGHTING_RESIST
	const HELD_PSYCHIC_TYPE_RESIST
	const HELD_DARK_RESIST
	const HELD_GHOST_RESIST
	const HELD_DRAGON_RESIST
	const HELD_POISON_RESIST
	const HELD_ROCK_RESIST
	const HELD_GROUND_RESIST
	const HELD_ELECTRIC_RESIST
	const HELD_BUG_RESIST
	const HELD_STEEL_RESIST
	const HELD_FLYING_RESIST
