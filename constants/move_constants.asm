...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const MEGA_DRAIN   ; 48
	const LEECH_SEED   ; 49
	const DRAGON_CLAW  ; 4a
	const RAZOR_LEAF   ; 4b
	const SOLARBEAM    ; 4c
	const POISONPOWDER ; 4d
	const STUN_SPORE   ; 4e
	const ENERGY_BALL  ; 4f
	const PETAL_DANCE  ; 50
	const STRING_SHOT  ; 51
	const WIDE_BREAKER ; 52
	const FIRE_SPIN    ; 53
