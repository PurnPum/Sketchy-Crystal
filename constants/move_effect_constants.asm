; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_ALWAYS_CRIT_POISON
	const EFFECT_ROCK_THROW
	...
	const EFFECT_FLY
	const EFFECT_SELF_ATTACK_DOWN
	const EFFECT_SELF_SPATT_DOWN
	const EFFECT_UTURN
	const EFFECT_HAIL
	const EFFECT_BLIZZARD
	const EFFECT_BIND
	const EFFECT_STATS_DOWN_PSN
	const EFFECT_COTTON_SPORE
	const EFFECT_SCARY_FACE
	const EFFECT_SWEET_KISS
