...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	const EVENT_GOT_SCYTHE_CUT
	const EVENT_GOT_BALLOONS_FLY
	const EVENT_GOT_SWIMSUIT_SURF
	const EVENT_GOT_POWER_GLOVES_STRENGTH
	const EVENT_GOT_FLASHLIGHT_FLASH
	const EVENT_GOT_PROPELLER_WHIRLPOOL
	const_skip ; unused
; Rods
...
; Johto story events
	...
	const EVENT_GOT_HAMMER_ROCK_SMASH
	const EVENT_LANCE_HEALED_YOU_IN_TEAM_ROCKET_BASE
	const EVENT_USED_ELMS_HEALING_MACHINE
	...
	const EVENT_GOT_POTIONS_IN_ROUTE_32
	const EVENT_GOT_STARDUST_IN_CHARCOAL_KILN
	const EVENT_GOT_TM02_HEADBUTT
	const EVENT_DECIDED_TO_HELP_LANCE
	const EVENT_GOT_HERACROSS_FROM_KIYO
	const EVENT_MET_FRIEDA_OF_FRIDAY
	const EVENT_GOT_POISON_BARB_FROM_FRIEDA
	const EVENT_MET_CLERK_CHERRYGROVE_CANDY_MACHINE
	const EVENT_GOT_PINK_BOW_FROM_TUSCANY ;Unused 
...
; Johto hidden items
	const EVENT_TIN_TOWER_4F_HIDDEN_ULTRA_POTION
	...
	const_skip ; unused in Crystal
	const_skip ; unused in Crystal
	const EVENT_NATIONAL_PARK_HIDDEN_BIG_MUSHROOM
	...
	const EVENT_ILEX_FOREST_HIDDEN_PARLYZ_HEAL
	const EVENT_ILEX_FOREST_HIDDEN_SODA_POP
	const EVENT_ILEX_FOREST_HIDDEN_LIGHT_BALL
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_GREAT_BALL
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_SODA_POP
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_BERRY_JUICE
	const EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_HIDDEN_ULTRA_POTION
	...
	const EVENT_ICE_PATH_B1F_HIDDEN_ULTRA_POTION
	...
	const EVENT_SILVER_CAVE_ROOM_2_HIDDEN_ULTRA_POTION
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_HIDDEN_FRESH_WATER
	const EVENT_VICTORY_ROAD_HIDDEN_ULTRA_POTION
	const EVENT_VICTORY_ROAD_HIDDEN_FULL_HEAL
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_REVIVE
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_ULTRA_POTION
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_SUPER_ELIXER
	const EVENT_ROUTE_28_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_30_HIDDEN_POTION
	const EVENT_ROUTE_32_HIDDEN_ELIXER
	const EVENT_ROUTE_32_HIDDEN_REVIVE
	const EVENT_ROUTE_34_HIDDEN_SODA_POP
	const EVENT_ROUTE_34_HIDDEN_SUPER_ETHER
	const EVENT_ROUTE_37_HIDDEN_ETHER
	const EVENT_ROUTE_39_HIDDEN_NUGGET
	const EVENT_ROUTE_40_HIDDEN_HYPER_POTION
	const EVENT_ROUTE_41_HIDDEN_SUPER_ETHER
	const EVENT_ROUTE_42_HIDDEN_ULTRA_POTION
	...
	const EVENT_CIANWOOD_CITY_HIDDEN_SUPER_ETHER
...
; Kanto hidden items
	...
	const EVENT_ROCK_TUNNEL_B1F_HIDDEN_ULTRA_POTION
	...
	const EVENT_ROUTE_2_HIDDEN_SUPER_ETHER
	...
	const EVENT_ROUTE_17_HIDDEN_SUPER_ETHER
	const EVENT_ROUTE_17_HIDDEN_SUPER_ELIXER
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_CRACKING_ICE_STAGE_1_A	; These are used in ice caves with cracking ice to track its changes
	const EVENT_CRACKING_ICE_STAGE_2_A
	const EVENT_CRACKING_ICE_STAGE_1_B
	const EVENT_CRACKING_ICE_STAGE_2_B
	const EVENT_CRACKING_ICE_STAGE_1_C
	const EVENT_CRACKING_ICE_STAGE_2_C
	const EVENT_CRACKING_ICE_STAGE_1_D
	const EVENT_CRACKING_ICE_STAGE_2_D
	const EVENT_CRACKING_ICE_STAGE_1_E
	const EVENT_CRACKING_ICE_STAGE_2_E
...
; Johto itemballs
	...
	const EVENT_VIOLET_CITY_STAR_PIECE
	const EVENT_VIOLET_CITY_FRESH_WATERS
	const EVENT_LAKE_OF_RAGE_ELIXER
	const EVENT_LAKE_OF_RAGE_TM_DETECT
	const EVENT_SPROUT_TOWER_1F_FULL_HEAL
	const EVENT_SPROUT_TOWER_2F_RAGECANDYBARS
	const EVENT_SPROUT_TOWER_3F_POKE_BALLS
	const EVENT_SPROUT_TOWER_3F_ESCAPE_ROPES
	...
	const EVENT_TIN_TOWER_8F_SUPER_ELIXER
	...
	const EVENT_NATIONAL_PARK_GIFT_SACK
	const EVENT_NATIONAL_PARK_TM_DIG
	const EVENT_UNION_CAVE_1F_GREAT_BALL
	const EVENT_UNION_CAVE_1F_POTIONS
	const EVENT_UNION_CAVE_1F_ETHERS
	const EVENT_UNION_CAVE_1F_PARLYZ_HEALS
	const EVENT_UNION_CAVE_B1F_TM_SWIFT
	const EVENT_UNION_CAVE_B1F_POKE_BALLS
	const EVENT_UNION_CAVE_B2F_NUGGET
	const EVENT_UNION_CAVE_B2F_STAR_PIECE
	const EVENT_SLOWPOKE_WELL_B1F_FRESH_WATERS
	...
	const EVENT_ILEX_FOREST_GREAT_BALLS
	...
	const EVENT_GOLDENROD_DEPT_STORE_B1F_ETHERS
	const EVENT_GOLDENROD_DEPT_STORE_B1F_AMULET_COIN
	const EVENT_GOLDENROD_DEPT_STORE_B1F_BURN_HEALS
	const EVENT_GOLDENROD_DEPT_STORE_B1F_PARLYZ_HEALS
	const EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_SUPER_ETHER
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_ULTRA_POTION
	...
	const EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_ULTRA_POTION
	...
	const EVENT_WHIRL_ISLAND_B2F_SUPER_ELIXER
	const EVENT_SILVER_CAVE_ROOM_1_SUPER_ELIXER
	...
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_ELIXERS
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_PARALYZ_HEAL
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_BURN_HEALS
	const EVENT_DARK_CAVE_ROUTE46_ENTRANCE_ETHERS
	const EVENT_DARK_CAVE_ROUTE46_ENTRANCE_TM_SNORE
	...
	const EVENT_ROUTE_26_SUPER_ELIXER
	const EVENT_ROUTE_27_TM_SOLARBEAM
	const EVENT_ROUTE_27_RARE_CANDY
	const EVENT_ROUTE_29_RAGECANDYBARS
	const EVENT_ROUTE_31_ANTIDOTES
	const EVENT_ROUTE_31_POKE_BALL
	const EVENT_ROUTE_32_PROTEINS
	...
	const EVENT_ROUTE_43_SUPER_ETHER
	...
	const EVENT_ROUTE_45_ULTRA_POTION
	const EVENT_ROUTE_46_POTIONS
; Johto people
	...
	const EVENT_WHITNEY_AT_SUDOWOODO
...
; Kanto itemballs
	...
	const EVENT_ROUTE_2_ULTRA_POTION
...
; New to Crystal
	...
	const EVENT_PICKED_UP_SUPER_ETHERS_FROM_HO_OH_ITEM_ROOM
	...
	const EVENT_PICKED_UP_FULL_HEAL_FROM_OMANYTE_ITEM_ROOM
	...
	const EVENT_MOUNT_MORTAR_1F_INSIDE_ULTRA_POTION
	...
	const EVENT_ROUTE_30_ETHERS
	const EVENT_ILEX_FOREST_SUPER_POTIONS
	const EVENT_ILEX_FOREST_NUGGET
	const EVENT_ILEX_FOREST_ELIXERS
	...
	const EVENT_DRAGONS_DEN_B1F_SUPER_ELIXER
	...
	const EVENT_TIN_TOWER_6F_ULTRA_POTION
	...
	const EVENT_MOUNT_MORTAR_B1F_SUPER_ETHER
...
; Repurposed
	...
	const EVENT_AZALEA_TOWN_SLOWPOKETAIL_BUGSY_KICKING_ASS
	const EVENT_SHUCKLE_CAVE_ALREADY_SEEN_TEXT
	const EVENT_ROUTE_34_IRONS
	const EVENT_ROUTE_34_CARBOS
	const EVENT_ROUTE_35_CALCIUMS
	const EVENT_MELTING_CAVE_BIG_PEARL
	const EVENT_MELTING_CAVE_CALCIUMS
	const EVENT_MELTING_CAVE_PP_UP
	const EVENT_MELTING_CAVE_POTIONS
	const EVENT_MELTING_CAVE_PROTEINS
	const_next 2048
