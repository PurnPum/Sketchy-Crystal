...
INCLUDE "engine/battle/move_data_operations.asm"
...
INCLUDE "data/pokemon/evos_attacks_pointers2.asm"
INCLUDE "data/pokemon/evos_attacks2.asm"
INCLUDE "engine/pokemon/fill_moves2.asm"
